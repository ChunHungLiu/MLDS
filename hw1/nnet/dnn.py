...
class DNN:
    ...
    def __init__(self, layers, Ws=None, bs=None,m_norm=None, act="ReLU", cost="CE",momentum_type="adagrad"):
        ...
        rms_alpha = T.scalar(dtype='float32')

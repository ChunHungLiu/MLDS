...
import Keras_model_annotation_noLSTM as Akar
from vqa import annotation_load_data
...
MODEL = 'annotation_noLSTM_batch_{}'.format(batch_size)

print 'Loading data...'
(X_train,Y_train),(X_test,Y_test) = annotation_load_data()

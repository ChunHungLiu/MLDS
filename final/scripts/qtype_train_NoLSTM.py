...
import Keras_model_qtype_noLSTM as Akar
from vqa import qtype_load_data
...
MODEL = 'qtype_noLSTM_batch_{}'.format(batch_size)

print 'Loading data...'
(X_train,Y_train),(X_test,Y_test) = qtype_load_data()

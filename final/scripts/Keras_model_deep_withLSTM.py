...
def keras_model( batch_dim , image_vector=1000 , word_vector=300 ):
    ...
    layer_LSTM_q = LSTM(output_dim=LSTM_units) # exp other act
    ...
    layer_LSTM_1 = LSTM(output_dim=LSTM_units)
    ...
    layer_LSTM_2 = LSTM(output_dim=LSTM_units)
    ...
    layer_LSTM_3 = LSTM(output_dim=LSTM_units)
    ...
    layer_LSTM_4 = LSTM(output_dim=LSTM_units)
    ...
    layer_LSTM_5 = LSTM(output_dim=LSTM_units)

...
SAVE_EPOCH = 20
VAL_RATIO = 0.05
MODEL_FILE_NAME = '../../models/dnn_6layer_decayBATCH'
EXP_FILE_NAME = '../../exp/dnn_6layer_decayBATCH'
#===== load training data =====
...
#load wrods 
ID_PKL = pickle.load(open(data_prefix+paths[0]+stop+'.pkl','rb'))
...
HEADER = ["epoch","error_rate","independant_error_rate"]

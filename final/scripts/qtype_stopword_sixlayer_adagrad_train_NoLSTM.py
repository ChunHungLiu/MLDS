...
import qtype_sixlayer_noLSTM as Akar
from vqa import stop_load_data,qtype_load_data
...
MODEL = 'qtype_stop_sixlayeradagrad_noLSTM_batch_{}'.format(batch_size)

print 'Loading data...'
(X_train,Y_train),(X_test,Y_test) = stop_load_data()

Y_train = qtype_load_data()[0][1]

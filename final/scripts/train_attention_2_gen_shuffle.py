...
SAVE_EPOCH = 20
VAL_RATIO = 0.05
MODEL_FILE_NAME = '../models/attention2_gen_shuffle'
EXP_FILE_NAME = '../exp/attention2_gen_shuffle'
#===== load training data =====
...
for epoch in xrange(MAX_EPOCH):
    ...
    for batch_num in xrange(0,int(len(pickList)/BATCH_SIZE)):
        ...
        start = batch_num*BATCH_SIZE/SHUFFLE_NUM 
        end   = (batch_num+1)*BATCH_SIZE/SHUFFLE_NUM
        if end > len(pickList):

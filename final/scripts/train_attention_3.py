...
import Keras_model_attention_3
...
SAVE_EPOCH = 20
VAL_RATIO = 0.05
MODEL_FILE_NAME = '../models/attention3_1_6_decay'
EXP_FILE_NAME = '../exp/attention3_1_6_decay'
#===== load training data =====
...
model = Keras_model_attention_3.keras_model()
